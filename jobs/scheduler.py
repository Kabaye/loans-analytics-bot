...
from bot.repositories.borrowers import lookup_borrower, upsert_borrower, upsert_borrower_from_investment
...
from bot.repositories.opi_cache import get_stale_opi_documents, save_opi_result
...
from bot.repositories.legacy_database import deactivate_missing_overdue_cases
...
from bot.integrations.parsers.kapusta import KapustaBlockedError, KapustaParser
...
async def midnight_refresh_investments(bot: Bot) -> None:
    ...
    # Notify admin
    try:
        from bot.repositories.borrowers import get_borrowers_count
