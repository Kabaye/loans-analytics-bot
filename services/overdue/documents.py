...
def _build_finkit_claim_text(case: dict, creditor: dict) -> str:
    ...
    consequences_intro = "Обращаю ваше внимание, что предъявление вашего долга к принудительному взысканию повлечет для вас:"
    consequences = "\n".join([
    ...
    companion_costs = (
        "Обращаю внимание, что при обращении в суд сумма требований будет увеличена, поскольку проценты за пользование займом "
